...
# Обучение модели
callbacks = [EarlyStopping(patience=10), ModelCheckpoint('my_model.h5', save_best_only=True)]
...
dump({'scaler': scaler, 'label_encoder_sport': label_encoder_sport, 'label_encoder_position': label_encoder_position}, 'preprocessing_objects.joblib')
